...
%   PAOLO: staminali concentrare in un quadrato più piccolo
%       della base de necrotico e centrate sulla base di questo.
...
# % La frontiera sta inizialmente dove stanno le staminali
# ptab(1:sx0,1:sx1) = o;
# ptab(1:sx0,sx1:m) = o;
# ptab(1:sx0,sx1:m) = o;
# ptab(sx0:n,sx1:m) = o;
